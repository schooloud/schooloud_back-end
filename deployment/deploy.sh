...
sudo echo PROXY_SERVER=\"133.186.221.10\" | sudo tee -a /etc/environment
...
sudo echo OPENSTACK_AUTH_URL=\"http://211.37.149.11/identity\" | sudo tee -a /etc/environment
sudo echo OPENSTACK_ADMIN_PROJECT=\"3ef80dc22af34184a45fb903877dcbd3\" | sudo tee -a /etc/environment
